 ...
 *  
 */
public class ListenerSaveAll implements ActionListener {
	...
	public ListenerSaveAll(UserFrame pUserFrame) {
		super();
	...
	public void actionPerformed(ActionEvent pAE) {
		UserDesktopPane lDesktopPane = mUserFrame.getDesktopPane();
		mUserFrame.getUserControl().saveAllTrees(lDesktopPane);
	}

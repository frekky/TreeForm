...
public class UserButtonPulldownBackground extends JButton implements Observer {
	...
	public UserButtonPulldownBackground(UserFrame userFrame, boolean iconSize, ObservableFontColor color, ObservableNew observableNew) {
		super();
		mColor = Color.yellow;
		mIconSize = iconSize;

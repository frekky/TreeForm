...
public class UserButtonPulldownLine extends JButton implements Observer {
	...
	public UserButtonPulldownLine(UserFrame userFrame, boolean iconSize, ObservableFontColor color, ObservableNew observableNew) {
		super();
		mColor = Color.yellow;
		mIconSize = iconSize;

 ...
 * 
 **/
public class UserButtonRedo extends JButton implements Observer{
	 ...
	 * @param pObservableStack The shared observable used the undo/redo buttons
	 * 
	 */
	public UserButtonRedo(UserFrame pUserFrame, 

 ...
 *  
 */
public class ButtonUIUnary extends ButtonUIAbstract {

	static ButtonUIUnary b = new ButtonUIUnary();
	public ButtonUIUnary() {
		super();
	}
	...
	public void paint(Graphics pG, JComponent pC) {
		...
		AttributedString ats = new AttributedString("Unary");

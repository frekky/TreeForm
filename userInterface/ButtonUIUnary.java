 ...
 *  
 */
public class ButtonUIUnary extends UserBrowserButton {
	...
	public ButtonUIUnary(UserFrame pUserFrame, Object pButtonType) {
	...
	public void paintComponent(Graphics pG) {
		...
		this.prepaint(pG);	
		AttributedString ats = new AttributedString("F8");

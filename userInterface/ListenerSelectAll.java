 ...
 *  
 */
public class ListenerSelectAll implements ActionListener {
	...
	public ListenerSelectAll(UserFrame pUserFrame) {
		super();
	 ...
	 * <br>
	 * This command calls the selectAll command in UserFrame
	 * 
	 */
	public void actionPerformed(ActionEvent pAE) {
		mUserFrame.getUserControl().selectAll();

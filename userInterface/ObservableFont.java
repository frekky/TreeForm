 ...
 *  
 */
public class ObservableFont extends Observable {

	private String mFont;
	/**
	 * Constructor
	 * @param pFont - passes a font.
	 * <br>
	 * 
	 */
	public ObservableFont(String pFont) {
	...
	/**
	 * 
	 * @param pFont - passes a value for the Observable, in this case a font object
	 * <br>
	 ...
	 */
	public void setValue(String pFont)
	 {
		mFont = pFont;
		setChanged();
		notifyObservers();
	...
	/**
	 * 
	 * @return getValue - passes a value from the Observable, in this case a font.
	 * <br>

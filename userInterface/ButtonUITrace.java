 ...
 *  
 */
public class ButtonUITrace extends ButtonUIAbstract {

	static ButtonUITrace b = new ButtonUITrace();
	public ButtonUITrace() {
		super();
	}
	...
	public void paint(Graphics pG, JComponent pC) {
		...
		AttributedString ats = new AttributedString("Trace");
		...
		ats.addAttribute(TextAttribute.SUPERSCRIPT,TextAttribute.SUPERSCRIPT_SUB,2,3);

		//AffineTransform aft = g2.getTransform();
		//aft.scale(aft.getScaleX()*2/3,aft.getScaleY()*2/3);
		//aft.translate(aft.getTranslateX(),aft.getTranslateY());
		//ats.addAttribute(TextAttribute.FONT, f,4,5);

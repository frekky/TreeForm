 ...
 *  
 */
public class ListenerItalics implements ActionListener {
	...
	public ListenerItalics(UserFrame pUserFrame) {
		super();
	 ...
	 * 
	 * This command changes ObservableFontItalic boolean and passes italics
	 * to the highlighted text.
	 * 
	 */
	public void actionPerformed(ActionEvent pAE) {
		mUserFrame.getObservableFontItalic().setValue(((JToggleButton)pAE.getSource()).isSelected());

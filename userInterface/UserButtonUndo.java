 ...
 * 
 **/
public class UserButtonUndo extends JButton implements Observer{
	 ...
	 * @param pObservableStack The shared observable used by the undo/redo
	 * toolbar options.
	 * 
	 */

	public UserButtonUndo(UserFrame pUserFrame, 

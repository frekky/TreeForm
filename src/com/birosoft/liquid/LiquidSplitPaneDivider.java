...
class LiquidSplitPaneDivider extends BasicSplitPaneDivider
{
	...
	/**
	 * 
	 * @uml.property name="skinVertSplitter"
	 * @uml.associationEnd 
	 * @uml.property name="skinVertSplitter" multiplicity="(0 1)"
	 */
	Skin skinVertSplitter = null;

	/**
	 * 
	 * @uml.property name="skinHorzSplitter"
	 * @uml.associationEnd 
	 * @uml.property name="skinHorzSplitter" multiplicity="(0 1)"
	 */

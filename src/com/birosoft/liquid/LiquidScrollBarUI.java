...
public class LiquidScrollBarUI extends BasicScrollBarUI
{
     ...
     *
     * @uml.property name="skinTrack"
     * @uml.associationEnd
     * @uml.property name="skinTrack" multiplicity="(0 1)"
     */
     ...
     *
     * @uml.property name="skinThumb"
     * @uml.associationEnd
     * @uml.property name="skinThumb" multiplicity="(0 1)"
     */
    private Skin skinThumb;

    /**
     *
     * @uml.property name="skinThumbIndexModel"
     * @uml.associationEnd
     * @uml.property name="skinThumbIndexModel" multiplicity="(1 1)"
     */
    ...
    /**
     *
     * @uml.property name="decreaseButton"
     * @uml.associationEnd
     * @uml.property name="decreaseButton" multiplicity="(0 1)"
     */
    JButton decreaseButton;

    /**
     *
     * @uml.property name="increaseButton"
     * @uml.associationEnd
     * @uml.property name="increaseButton" multiplicity="(0 1)"
     */
    ...
    public void paint(Graphics g, JComponent c)
    {
        ...
        int x = orientation == Adjustable.VERTICAL ? thumbBounds.x + 1 : thumbBounds.x;
        int y = orientation == Adjustable.VERTICAL ? thumbBounds.y : thumbBounds.y + 1;
        int width = orientation == Adjustable.VERTICAL ? thumbBounds.width - 2 : thumbBounds.width;
        int height = orientation == Adjustable.VERTICAL ? thumbBounds.height : thumbBounds.height - 2;
     ...
     * @return Skin
     *
     * @uml.property name="skinTrackHoriz"
     */
     ...
     * @return Skin
     *
     * @uml.property name="skinTrackVert"
     */
    ...
    public Skin getSkinTrack() {
        if (skinTrack == null) {
            skinTrack = (scrollbar.getOrientation() == Adjustable.VERTICAL)
                ? getSkinTrackVert()
                    : getSkinTrackHoriz();
        }
        return skinTrack;
    ...
    public Skin getSkinThumb() {
        if (skinThumb == null) {
            skinThumb = (scrollbar.getOrientation() == Adjustable.VERTICAL)
                ? getSkinThumbVert()
                    : getSkinThumbHoriz();
        }
        return skinThumb;

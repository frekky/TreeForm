 ...
 *
 */
public class ListenerPrintPreview implements ActionListener {
    ...
    public ListenerPrintPreview(UserFrame pUserFrame) {
        super();
     ...
     * <br>
     * This command calls the print preview command from UserControl
     *
     */
    public void actionPerformed(ActionEvent pAE) {
        mUserFrame.getUserControl().printPreview();

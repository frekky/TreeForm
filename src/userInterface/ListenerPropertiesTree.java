 ...
 *
 */
public class ListenerPropertiesTree implements ActionListener {
    ...
    public ListenerPropertiesTree(UserFrame pUserFrame) {
        super();
     ...
     * <br>
     * This command calls the editPresentation command in UserControl
     *
     */
    public void actionPerformed(ActionEvent pAE) {
        mUserFrame.getUserControl().editPresenation();

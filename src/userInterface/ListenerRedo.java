 ...
 *
 */
public class ListenerRedo implements ActionListener {
    ...
    public ListenerRedo(UserFrame pUserFrame) {
        super();
     ...
     * <br>
     * This command calls redo command in UserControl
     *
     */
    public void actionPerformed(ActionEvent pAE) {
        mUserFrame.getUserControl().redo();

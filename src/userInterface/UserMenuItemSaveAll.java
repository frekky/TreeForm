 ...
 * <br>
 * <br>
 * The MenuItem Save all trees
 */
public class UserMenuItemSaveAll extends JMenuItem implements Observer{
 ...
 */
	public UserMenuItemSaveAll(String pString, Icon pIcon, ObservableNew pObservableNew) {
		super(pString, pIcon);

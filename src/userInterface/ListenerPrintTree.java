 ...
 *
 */
public class ListenerPrintTree implements ActionListener {
    ...
    public ListenerPrintTree(UserFrame pUserFrame) {
        super();
     ...
     * <br>
     * This command calls the printTree command from UserControl
     *
     */
    public void actionPerformed(ActionEvent pAE) {
        mUserFrame.getUserControl().printTree();

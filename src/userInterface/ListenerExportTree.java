 ...
 *
 */
public class ListenerExportTree implements ActionListener {
    ...
    public ListenerExportTree(UserFrame pUserFrame) {
        super();
     ...
     *
     * This command exports the pictrue by grabbing a copy of the Syntax Facade and
     * passing it to the exportPicture command (which forwards the information to
     * the correct parser.
     *
     */
    public void actionPerformed(ActionEvent pAE) {
        mUserFrame.getUserControl().exportPicture(
            mUserFrame.getSyntaxFacade());

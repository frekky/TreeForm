 ...
 *
 */
public class ListenerFontName implements ActionListener {
    ...
    public ListenerFontName(UserFrame pUserFrame) {
        super();
     ...
     *
     * This command sets the font to the observed font to selected value
     * and sets the highlighted text to the observed font.
     *
     */

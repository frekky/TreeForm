 ...
 * 
 */
public class ListenerButtonBackgroundColor implements ActionListener {
	...
	public ListenerButtonBackgroundColor(UserFrame userFrame, UserButtonBackgroundColor backgroundColor) {
		super();
	...
	public void actionPerformed(ActionEvent pAE) {
		mUserFrame.getSyntaxFacade().changeAttributes(TextAttribute.BACKGROUND,mBackgroundColor.getColor());
	}
}
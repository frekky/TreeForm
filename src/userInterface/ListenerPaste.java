 ...
 *
 */
public class ListenerPaste implements ActionListener {
    ...
    public ListenerPaste(UserFrame pUserFrame) {
        super();
     ...
     * <br>
     * This command calls the paste command from the UserControl.
     *
     */
    public void actionPerformed(ActionEvent pAE) {
        mUserFrame.getUserControl().paste();
    }
}

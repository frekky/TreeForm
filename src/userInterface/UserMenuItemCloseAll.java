 ...
 * <br>
 * <br>
 * The MenuItem Close menu
 */
public class UserMenuItemCloseAll extends JMenuItem implements Observer {
     ...
     * @param pObservableNew The ObservableNew Object containing the count of InternalFrames
     */
    public UserMenuItemCloseAll(String string , ObservableNew pObservableNew) {
        super(string);

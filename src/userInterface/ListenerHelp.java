 ...
 *  
 */
public class ListenerHelp implements ActionListener {
	...
	public ListenerHelp(UserFrame pUserFrame) {
		super();
	 ...
	 * 
	 * This command calls the user control and requests the opening of the help
	 * screen.
	 * 
	 */
	public void actionPerformed(ActionEvent pAE) {
		mUserFrame.getUserControl().openHelp();
